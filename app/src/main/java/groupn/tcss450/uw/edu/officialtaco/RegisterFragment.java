...
public class RegisterFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        u = (EditText) v.findViewById(R.id.regusername);
        p = (EditText) v.findViewById(R.id.regpassword);
        p2 = (EditText) v.findViewById(R.id.regcomfirm);
        return v;
    }
    @Override
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onLoginInteraction(CharSequence u, CharSequence p);
    }
    ...
    private class CreateWebServiceTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if(!result.equals("[]")) {
                ...
                mListener.onLoginInteraction(u.getText(), p.getText());
            }
